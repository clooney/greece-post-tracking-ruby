# ELTA Hellenic Post Tracking API For Ruby
ELTA Hellenic Post Tracking API and webhook make it easy to integrate ELTA Hellenic Post Tracking function into your own project. Support APIs Client Libraries for ruby

### API key

In order to use this API, you need to generate a ELTA Hellenic Post Tracking  API key in the [TrackingMore](https://www.trackingmore.com).
...
------------------------------------------------------------------------------------------------------------------
[TrackingMore](https://www.trackingmore.com) is a multiple carrier solutions. Developers can get tracking results from 410+ couriers by integrating trackingmore API.Check the courier code. use ELTA Hellenic Post Tracking API of Trackingmore  allows eCommerce developers in any sizes to add package tracking fuction easily. Use [ELTA Hellenic Post Tracking API](https://www.trackingmore.com/greece-post-tracking.html)  to:

   *   Get ELTA Hellenic Post realtime tracking info of muti-carriers in one integration
   *   Provide ELTA Hellenic Post shipment tracking experience like Amazon
   *   Push ELTA Hellenic Post notifications of package update with webhook
   *   Verify ELTA Hellenic Post delivery exception before it is too late
